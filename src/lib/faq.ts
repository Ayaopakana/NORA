...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Мы сотрудничаем с локальными заведениями: они размещаются во вкладке «Партнёры», а вы получаете персональные бонусы и скидки. Покажите экран NORA на кассе или назовите промокод из карточки партнёра.',
  },
  {
    id: 'friends',
